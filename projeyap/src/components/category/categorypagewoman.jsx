...
const CategoryPageMan = () => {
  ...
  const urunler = urun.productswoman;
  ...
  return (
    <>
      ...
      <div className="panel">
        ...
        <button
  className={`categorybtnman ${selectedCategory === "tumunuGoster" && "selected"}`}
  onClick={() => {
...
<button
  className={`categorybtnman ${selectedCategory === "giyim" && "selected"}`}
  onClick={() => {
...
<button
  className={`categorybtnman ${selectedCategory === "ayakkabi" && "selected"}`}
  onClick={() => {
...
<button
  className={`categorybtnman ${selectedCategory === "canta" && "selected"}`}
  onClick={() => {
...
>
  Çanta
          ...
          <button id="odemeyap"><Link style={{textDecoration:'none',color:'white'}} to="/payment" state={{price: toplamFiyat}}>Ödeme Yap {toplamFiyat}$</Link></button>
